function NavigationIcons() {
  return [
    ...
    },
    {
      ...
      name: "Graphic Design and Visual Arts",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      name: "Animation and 3D Modeling",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      name: "Digital Advertising and Marketing",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
